            ...
            if (isset($_POST['upPerfil'])) {
                ...
                if (!empty($_FILES['foto']['name'])) {
                    ...
                    if (in_array($extensao, $formatP)) {
                        $pasta = "../img/"; // Define o diretório de upload
            ...
            <div class="card">
              ...
              <div class="card-body p-0" style="text-align: center; margin-bottom: 98px">
                ...
                if ($foto_user == 'avatar-padrao.png') {
                    ...
                    echo '<img src="../img/avatar_p/' . $foto_user . '" alt="' . $foto_user . '" title="' . $foto_user . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
                } else {
                    // Exibe a imagem do usuário
                    echo '<img src="../img/' . $foto_user . '" alt="' . $foto_user . '" title="' . $foto_user . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
                }
                ?>
