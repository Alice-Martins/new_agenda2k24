                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    try{
                      ...
                      $cont = 1; // Inicializa o contador de linhas  // Vincula o ID do usuário ao parâmetro :id_user
                    ...
                    <tr>
                          ...
                          if ($show->foto_contatos == 'avatar-padrao.png') {
                              ...
                              echo '<img src="../img/avatar_p/avatar-padrao.png' . $show->foto_contatos . '" alt="' . $show->foto_contatos . '" title="' . $show->foto_contatos . '" style="width: 50px; border-radius: 100%;">';
                          } else {
                  ...
                  <strong>Contatos não encontrados!</strong></div>' . $e->getMessage();
              }
                   ?>
                  </tbody>
                  <tfoot>
